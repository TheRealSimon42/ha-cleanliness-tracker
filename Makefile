...
fmt:
	ruff format custom_components/cleanliness_tracker tests

lint:
	ruff check custom_components/cleanliness_tracker tests

type:
	mypy --strict custom_components/cleanliness_tracker

test:
	pytest

cov:
	pytest --cov=custom_components.cleanliness_tracker --cov-report=term-missing --cov-report=html --cov-branch
